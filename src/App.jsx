...
const productionDeliverables = {
  "Paid Media": [
    ["Founder video cutdowns", "Adapt Nicola intro video into Meta and LinkedIn cutdowns.", "Mid-May", "Marketing / Video"],
    ["Features and benefits video", "Produce product walkthrough covering the brief, approve, covered flow.", "Late May", "Marketing / Video"],
    ["Meta ad set", "Build 6 creative concepts, copy variants, audience segments, retargeting and Book a free demo CTA.", "Late May", "Marketing / Paid"],
    ["LinkedIn ad set", "Build sponsored content, Request Demo lead-gen form, targeting and retargeting layer.", "Late May", "Marketing / Paid"],
    ["Google Search campaign", "Build keyword set, ad copy, negative keyword list, conversion tracking and UTMs.", "Late May", "Marketing / Paid"],
    ["Weekly optimisation report", "Review CTR, cost per demo, demo volume, creative performance and budget split.", "Weekly from June", "Marketing"]
  ],
  "Organic Social": [
    ["Blog-to-social content map", "Map existing Pitchr blogs into Reels, carousels and static post formats.", "Mid-May", "Content"],
    ["Reel scripts", "Write 5 human-led explainers from blog content.", "Mid-May", "Content"],
    ["Carousel copy", "Write 4 carousel outlines and captions.", "Late May", "Content"],
    ["Static assets", "Create quote graphics, stat callouts and brand statements.", "Late May", "Design / Content"],
    ["12-post launch stockpile", "Finalise 5 Reels, 4 carousels and 3 static posts before launch.", "Before June 1", "Content / Design"],
    ["Weekly organic posts", "Publish Instagram and LinkedIn posts weekly from launch through August.", "Weekly June-August", "Content"]
  ],
  "Email": [
    ["Pre-launch tease email", "Something we have been building - drives early demo bookings.", "May 27", "Marketing"],
    ["Launch email", "We are live. Book your free demo.", "June 1", "Marketing"],
    ["Final reminder email", "Only [X] of 20 spots left. Book your free demo.", "June 8", "Marketing"],
    ["Demo follow-up nurture", "Three-email sequence for demo bookers who do not sign up.", "Late May", "Marketing"],
    ["Customer onboarding sequence", "Day 0, 2, 5, 10 and 14 onboarding emails.", "Late May", "Marketing / Product"],
    ["Monthly brand newsletter", "Brand POV, PR thinking and industry commentary.", "Monthly", "Marketing"]
  ],
  "Website": [
    ["Launch offer landing page", "3-for-2 offer page with clear inclusions and Book a free demo CTA.", "Late May", "Marketing / Dev"],
    ["Homepage hero update", "Feature the launch offer and demo CTA above the fold.", "Late May", "Marketing / Dev"],
    ["How it works refresh", "Add the Pitchr PR professional hand-holding angle.", "Late May", "Marketing / Dev"],
    ["Sustaining offer page", "Build 15% off first 3 months page ready to switch on.", "June", "Marketing / Dev"],
    ["Demo booking flow QA", "Test form, calendar, confirmation, UTMs and tracking.", "Late May", "Marketing / Dev"],
    ["Tracking setup", "Confirm Meta, LinkedIn, Google Ads and email pixels/UTMs.", "Late May", "Marketing / Dev"]
  ],
  "Referral": [
    ["Referral offer copy", "Write customer and referred-brand messaging.", "June", "Product / Marketing"],
    ["Referral dashboard widget", "Build persistent in-platform referral entry point.", "Mid-July", "Product"],
    ["Unique referral links", "Generate and track referral links per customer.", "Mid-July", "Product"],
    ["Coverage-triggered pop-up", "Prompt customers when coverage lands.", "Mid-July", "Product"],
    ["Referral follow-up email", "You are in [publication]. Want to do that for a friend?", "Mid-July", "Marketing / Product"],
    ["Reward tracking logic", "First referral free month, subsequent referrals 10% off next month.", "Mid-July", "Product"]
  ]
};

const productionScheduleRows = Object.entries(productionDeliverables).flatMap(([channel, rows]) => rows.map((row) => [channel, ...row]));
...
function runSelfTests() {
  ...
  if (Object.keys(productionDeliverables).length !== 5) errors.push("Expected five production deliverable groups.");
